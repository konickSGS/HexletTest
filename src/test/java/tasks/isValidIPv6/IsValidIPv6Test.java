...
public class IsValidIPv6Test {
    ...
    void shouldBeValid(String ip) {
        Assertions.assertTrue(IsValidIPv6.isValidIPv6(ip));
    }
    ...
    void shouldBeInvalid(String ip) {
        Assertions.assertFalse(IsValidIPv6.isValidIPv6(ip));
    }
}
